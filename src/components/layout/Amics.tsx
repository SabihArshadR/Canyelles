...
const Amics = () => {
  ...
  const [activeModelZoom, setActiveModelZoom] = useState<string | null>("normal");
  ...
  const findings: Finding[] = [
    { img: finding1, model: `${HOST}/models/1_clock_tower.glb`, altKey: "finding1", zoom: "normal" },
    { img: finding2, model: `${HOST}/models/2_rusty_tools.glb`, altKey: "finding2", zoom: "normal" },
    { img: finding3, model: `${HOST}/models/3_medieval_sword.glb`, altKey: "finding3", zoom: "normal" },
    { img: finding4, model: `${HOST}/models/4_basaltic_rock.glb`, altKey: "finding4", zoom: "moreless" },
    { img: finding5, model: `${HOST}/models/5_chariot.glb`, altKey: "finding5", zoom: "normal" },
    { img: finding6, model: `${HOST}/models/6_green_frog.glb`, altKey: "finding6", zoom: "normal" },
  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-white pb-8 md:pb-32">
      ...
      <div className="mt-8 flex flex-col items-center justify-center w-full max-w-4xl px-4">
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 md:gap-6 w-full px-2">
          {findings.map((item, index) => {
            const isUnlocked = index < unlockedCount;
            return (
              <div
                key={index}
                className={`relative aspect-square transition-all duration-300 ${!isUnlocked ? "opacity-50" : "hover:scale-105 cursor-pointer"
                  }`}
              >
                <button
      ...
      <ModelViewer
        ...
        zoomMode={activeModelZoom as "normal" | "moreless" | "less" | "large" ?? "normal"}
      />
    </div>
  );
};
